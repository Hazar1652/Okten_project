...
class HangoutListSerializer(serializers.ModelSerializer):
    """Публічний список відкритих зустрічей (з контактом для звʼязку)."""
...
class HangoutPublicDetailSerializer(HangoutListSerializer):
    """Деталі відкритої зустрічі — той самий набір полів, що й список."""

    class Meta(HangoutListSerializer.Meta):
        fields = HangoutListSerializer.Meta.fields + ["updated_at"]
